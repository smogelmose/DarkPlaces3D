Shader "Renge/ProgressBar"
{
	Properties
	{
		...
		[MainColor]_InnerColor("InnerColor", Color) = (1, 0, 0, 1)
		_BackgroundColor("BackgroundColor", Color) = (1, 1, 1, 1)
		_BorderColor("BorderColor", Color) = (0, 0, 0, 1)
		_InnerBorderColor("InnerBorderColor", Color) = (0.6603774, 0.009344946, 0.009344946, 1)
		...
		_PulseColor("PulseColor", Color) = (0, 0, 0, 1)
		...
		_ValueShadowColor("ValueShadowColor", Color) = (0, 0, 0, 1)
		...
		_ValueInsetShadowColor("ValueInsetShadowColor", Color) = (0, 0, 0, 1)
		_ValueInsetShadowSize("ValueInsetShadowSize", Float) = 0.1
		_ValueInsetShadowFalloff("ValueInsetShadowFalloff", Float) = 0.99
		_BorderInsetShadowColor("BorderInsetShadowColor", Color) = (0, 0, 0, 0)
		...
		SubShader
		{
			...
			Pass
			{
				...
				VertexOut vert(VertexIn IN)
				{
					...
					float _Split_502edbafd9814bd58824d9d26664e3bb_R_1 = IN.vertex[0];
					float _Split_502edbafd9814bd58824d9d26664e3bb_G_2 = IN.vertex[1];
					float _Split_502edbafd9814bd58824d9d26664e3bb_B_3 = IN.vertex[2];
					float _Split_502edbafd9814bd58824d9d26664e3bb_A_4 = 0;


					float _Multiply_276af5a28f6a4a7c803fff6851c51f10_Out_2;
					Unity_Multiply_float(_Split_502edbafd9814bd58824d9d26664e3bb_G_2, 2, _Multiply_276af5a28f6a4a7c803fff6851c51f10_Out_2);


					float _Property_25ddca59305f4ed781e40b451dac5291_Out_0 = _Slant;


					float _Multiply_96def025970b44468a7f3d744c2bd0c1_Out_2;
					Unity_Multiply_float(_Multiply_276af5a28f6a4a7c803fff6851c51f10_Out_2, _Property_25ddca59305f4ed781e40b451dac5291_Out_0, _Multiply_96def025970b44468a7f3d744c2bd0c1_Out_2);


					float _Add_be1daa31bee74913a632ff02021fc91b_Out_2;
					Unity_Add_float(_Multiply_96def025970b44468a7f3d744c2bd0c1_Out_2, _Split_502edbafd9814bd58824d9d26664e3bb_R_1, _Add_be1daa31bee74913a632ff02021fc91b_Out_2);


					float3 _Vector3_6297749c26024062b157c293811f49fe_Out_0 = float3(_Add_be1daa31bee74913a632ff02021fc91b_Out_2, _Split_502edbafd9814bd58824d9d26664e3bb_G_2, _Split_502edbafd9814bd58824d9d26664e3bb_B_3);

					description.vertex = UnityObjectToClipPos(float4(_Vector3_6297749c26024062b157c293811f49fe_Out_0, 0));//UnityObjectToClipPos(IN.vertex);//
				...
				fixed4 frag(VertexOut IN) : SV_TARGET
				{
					...
					return float4(_Multiply_9af9709282a249babf05f60fe81e58f6_Out_2.xyz, _Minimum_8cc0274d92394a969b7bc13221edf093_Out_2);
				}
				ENDCG
			}

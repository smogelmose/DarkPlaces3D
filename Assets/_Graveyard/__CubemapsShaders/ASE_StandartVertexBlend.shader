...
Shader "ASE/ASE_StandartVertexBlend"
{
	Properties
	{
		...
		[ASEEnd]_Metall("Metall", Range( 0 , 1)) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord233 = packedInput.ase_texcoord5.xy * temp_cast_0 + float2( 0,0 );
				...
				float4 temp_cast_1 = (HeightMask132).xxxx;
				float clampResult246 = clamp( CalculateContrast(_BlendContrastR,temp_cast_1).r , 0.0 , 1.0 );
				...
				float4 temp_cast_3 = (HeightMask151).xxxx;
				float clampResult247 = clamp( CalculateContrast(_BlendContrastG,temp_cast_3).r , 0.0 , 1.0 );
				...
				float2 temp_cast_4 = (_TilingB).xx;
				float2 texCoord237 = packedInput.ase_texcoord5.xy * temp_cast_4 + float2( 0,0 );
				...
				float4 temp_cast_5 = (HeightMask158).xxxx;
				float clampResult248 = clamp( CalculateContrast(_BlendContrastB,temp_cast_5).r , 0.0 , 1.0 );
				...
				float3 linearToGamma175 = FastLinearToSRGB( temp_cast_8 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 color183 = IsGammaSpace() ? float4(0,0,0,1) : float4(0,0,0,1);
				float2 temp_cast_0 = (_TilingR).xx;
				float2 texCoord233 = packedInput.ase_texcoord.xy * temp_cast_0 + float2( 0,0 );
				...
				float4 lerpResult145 = lerp( lerpResult133 , tex2D( _AlbedoG, OffsetPOM212 ) , temp_output_244_0);
				float2 temp_cast_4 = (_TilingB).xx;
				float2 texCoord237 = packedInput.ase_texcoord.xy * temp_cast_4 + float2( 0,0 );
		...
		Pass
		{
						...
						)
			{
				...
				float4 color183 = IsGammaSpace() ? float4(0,0,0,1) : float4(0,0,0,1);
				float2 temp_cast_0 = (_TilingR).xx;
				float2 texCoord233 = packedInput.ase_texcoord7.xy * temp_cast_0 + float2( 0,0 );
				...
				float4 lerpResult145 = lerp( lerpResult133 , tex2D( _AlbedoG, OffsetPOM212 ) , temp_output_244_0);
				float2 temp_cast_4 = (_TilingB).xx;
				float2 texCoord237 = packedInput.ase_texcoord7.xy * temp_cast_4 + float2( 0,0 );
				float2 OffsetPOM213 = POM( _HeightMapB, texCoord237, ddx(texCoord237), ddy(texCoord237), normalWS, V, ase_tanViewDir, 16, 16, ( 0.001 * _ParalaxOffsetB ), 0.5, _HeightMapB_ST.xy, float2(0,0), 0 );
				float4 clampResult155 = clamp( ( tex2D( _HeightMapB, OffsetPOM213 ) + _BlendFactorB ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float clampResult157 = clamp( (clampResult155).r , 0.0 , 1.0 );
				float HeightMask158 = saturate(pow(((clampResult157*packedInput.ase_color.b)*4)+(packedInput.ase_color.b*2),_BlendContrastB));
...
/*ASEBEGIN
Version=18912
43.33334;266.6667;1879.333;1112.333;3255.745;3020.365;2.857482;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;204;-1925.689,-2155.094;Float;True;Property;_HeightMapG;HeightMapG-----;12;0;Create;True;0;0;0;False;0;False;None;22a31970137c4014da4b3ebfe143f818;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;205;-1927.448,-1944.12;Float;True;Property;_HeightMapB;HeightMapB----;23;0;Create;True;0;0;0;False;0;False;None;4f6f6db0eda661549a8601eb4a125ef3;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;269;375.8651,-748.1265;Inherit;True;Property;_NormalMapG;NormalMapG;14;0;Create;True;0;0;0;False;0;False;-1;None;923ae7f9c4ac548429abe09ed8af61e4;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;121;-105.0141,-948.1488;Inherit;True;Property;_AlbedoG;AlbedoG;13;0;Create;True;0;0;0;False;0;False;-1;None;b49a724a3881552409b7577275cc01ba;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;143;-133.7745,-735.8284;Inherit;True;Property;_AlbedoB;AlbedoB;24;0;Create;True;0;0;0;False;0;False;-1;None;3a444c8a0067f804b9fdeddff19b4262;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;166;397.5298,-517.3137;Inherit;True;Property;_NormalMapB;NormalMapB;25;0;Create;True;0;0;0;False;0;False;-1;None;a8b50c19731c9434b8e1b9efcca573d3;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;200;1659.264,-408.4822;Float;False;Property;_Metall;Metall;34;0;Create;True;0;0;0;False;0;False;0.5;0.436;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=91AF402E2BE41C315FF99B1F21E5D0803F3CE7AA